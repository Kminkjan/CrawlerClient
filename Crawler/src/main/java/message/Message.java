...
public class Message {
    ...
    public enum MessageType {
        EDIT_VALUE, PROCESSED_URLS, DOCUMENT, CRAWLER_NOTIFY, PROCESSOR_NOTIFY, MODULE_NOTIFY, REQUEST_URL, GIVE_URL,
        SHUT_DOWN, URL_DONE, ORDER, ACTIVE, ACTIVE_PROCESS, SERVER, URL_DONE_ACTIVE
    }
